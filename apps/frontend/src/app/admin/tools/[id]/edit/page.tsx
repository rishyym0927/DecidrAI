 ...
 * Edit existing tool (placeholder - to be implemented)
 */
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl">
          <div className="p-8 border border-[var(--border)] rounded-2xl text-center">
            ...
            <h2 className="text-2xl font-bold mb-4">Edit Tool: {id}</h2>
            <p className="text-[var(--muted)] mb-6">
              Tool editing form will be implemented here. For now, please use the database directly.
            </p>
            <Link
              href="/admin/tools"
